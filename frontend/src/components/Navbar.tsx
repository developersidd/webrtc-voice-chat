...
const Navbar = () => {
  ...
  return (
    <header className="bg-primary container mx-auto py-5 px-4 sm:px-1 flex items-center justify-between ">
      ...
      {user?.id && (
        <div className="flex gap-4 items-center justify-center">
          ...
          <Link to="/">
            <img
              className="size-13 rounded-full border-[3px] border-blue"
              src={user.avatar}
              alt={user.fullName}
            />
          </Link>
